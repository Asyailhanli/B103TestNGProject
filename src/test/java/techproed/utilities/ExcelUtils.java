...
public class ExcelUtils {
    ...
    private String path;
//    Constructor : Excel path i ve sayfasina ulasmak icin kullanilir
...
//    Excel deki verileri Test sinifinda kullanmak icin bu methodu kullanacagiz
...
//    =================Excel deki datalari 2 boyutlu array seklinde alir==============
    public String[][] getDataArray() {//baslik dahil
...
//    ================Deger,Satir,Sutun girildiginde o satir ve sutuna girilen veriyi ekler=======
    ...
    // Bu method ustdeki methodla birlikte calisir.Overloading eder .Parametreleri farklidir.
...
//    Tum exceldeki datalari basliksiz olarak 2 boyutlu array seklinde return eder .Data provider da kullanilir
