...
public class Day25_DataProviderTest4 extends DataProviderUtils {
...
//    musteriVerileri
    ...
    public void musteriVerileriTest(String username,String password,String sube){
        System.out.println("Username :"+username+ "Password :"+password+"|||"+sube);
...
//    personelVerileri
    ...
    public void personelVerilerTest(String username, String password){
        System.out.println(username+" | "+password);
    }
//    customerData
